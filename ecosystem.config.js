  ...
  apps: [
    ...
    },
    {
      ...
      env: {
        ...
        CENTRAL_PAYMENT_SERVICE_URL: "https://rizq-baraka.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },
    {
      ...
      env: {
        ...
        CENTRAL_PAYMENT_SERVICE_URL: "https://muzaffar-savdo.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },
    {
      ...
      env: {
        ...
        TENANT_ID: "istiqlol",
        CENTRAL_PAYMENT_SERVICE_URL: "https://istiqlol.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },
    {
      ...
      env: {
        ...
        TENANT_ID: "bogdod",
        CENTRAL_PAYMENT_SERVICE_URL: "https://bogdod.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },

    {
      ...
      env: {
        ...
        CENTRAL_PAYMENT_SERVICE_URL: "https://beshariq-turon.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },
    {
      ...
      env: {
        ...
        TENANT_ID: "beshariq",
        CENTRAL_PAYMENT_SERVICE_URL: "https://beshariq.myrent.uz/api/v1",
        CENTRAL_PAYMENT_SERVICE_SECRET: "MyRent_MainSecretKey_h7Kz$9pX!q@w#eR",
      },
    },
  ],
